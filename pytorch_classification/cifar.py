...
import pytorch_classification.models.cifar as models

from pytorch_classification.utils import AverageMeter, accuracy, mkdir_p
...
def train(trainloader, model, model_index, criterion, optimizer, epoch, use_cuda):
